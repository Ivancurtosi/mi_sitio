(() => {
  ...
  layer.innerHTML = `
    ...
    <div class="ivo-polish-celebration"><small>IVO ROCK</small><strong>RUTA COMPLETA</strong><b>BONUS +0000</b></div>
  ...
  const celebrationBonus = celebration.querySelector('b');
