...
import RockTour from './assets/cosmic-jump-DkePWGqE.js?v=hero-enemies-1';
...
await import('./ivo-rock-polish.js?v=hero-enemies-1');
await import('./ivo-rock-stats.js?v=hero-enemies-1');
await import('./ivo-rock-start-menu.js?v=hero-enemies-1');