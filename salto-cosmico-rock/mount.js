...
import RockTour from './assets/cosmic-jump-DkePWGqE.js?v=finale-competition-1';
...
await import('./ivo-rock-polish.js?v=finale-competition-1');
await import('./ivo-rock-stats.js?v=finale-competition-1');
await import('./ivo-rock-start-menu.js?v=finale-competition-1');