...
import RockTour from './assets/cosmic-jump-DkePWGqE.js?v=run-grounded-1';
...
await import('./rock-tour-controls.js?v=performance-1');
await import('./ivo-rock-polish.js?v=performance-1');
