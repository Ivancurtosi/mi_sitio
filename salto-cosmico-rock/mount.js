...
import RockTour from './assets/cosmic-jump-DkePWGqE.js?v=boss-pedal-fix-1';
...
await import('./ivo-rock-polish.js?v=boss-pedal-fix-1');
await import('./ivo-rock-stats.js?v=boss-pedal-fix-1');
await import('./ivo-rock-start-menu.js?v=boss-pedal-fix-1');