...
import RockTour from './assets/cosmic-jump-DkePWGqE.js?v=approved-enemies-2';
...
await import('./ivo-rock-polish.js?v=approved-enemies-2');
await import('./ivo-rock-stats.js?v=approved-enemies-2');
await import('./ivo-rock-start-menu.js?v=approved-enemies-2');