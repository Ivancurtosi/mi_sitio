...
import RockTour from './assets/cosmic-jump-DkePWGqE.js?v=fine-polish-7';
...
await import('./ivo-rock-polish.js?v=fine-polish-7');
await import('./ivo-rock-stats.js?v=fine-polish-7');
await import('./ivo-rock-start-menu.js?v=fine-polish-7');