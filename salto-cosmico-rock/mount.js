...
import RockTour from './assets/cosmic-jump-DkePWGqE.js?v=complete-pass-3';
...
await import('./ivo-rock-polish.js?v=complete-pass-3');
await import('./ivo-rock-stats.js?v=complete-pass-3');
await import('./ivo-rock-start-menu.js?v=complete-pass-3');